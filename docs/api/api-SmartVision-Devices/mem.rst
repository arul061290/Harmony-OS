...
`memset() <utils.rst#gace6ee45c30e71865e6eb635200379db9>`__.
...
`malloc() <mem.rst#ga7ac38fce3243a7dcf448301ee9ffd392>`__ \|
`calloc() <mem.rst#ga62b7798461bd461da64c5f9d35feddf7>`__ \|
`realloc() <mem.rst#ga1a6b5e8d2f1c37e5b43e4345586075be>`__
...
`MAP_FAILED <mem.rst#ga8523dcf952f6ff059a3bed717e4f1296>`__ and sets
...
::
   ...
   int shmctl (int shmid, int cmd, struct [shmid_ds](shmid_ds.rst) * buf )
...
`IPC_CREAT <ipc.rst#gace43f23fcb66ddaad964bb8ea8de6e9c>`__ is specified
in **shmflg** or if **key** has the value
`IPC_PRIVATE <ipc.rst#gae2b9b856a4a657c250b0b2e1cc0835d9>`__, this
function creates a shared memory segment with the size equal to the
value of **size** rounded up to a multiple of
`PAGE_SIZE <utils.rst#ga7d467c1d283fdfa1f2081ba1e0d01b6e>`__.
