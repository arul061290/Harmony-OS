...
::
   ...
   typedef struct [CommonDeviceInfo](commondeviceinfo.rst) [CommonDeviceInfo](commondeviceinfo.rst)
...
::
   ...
   typedef enum [DeviceTypeEnum](softbus.rst#gab20b49630026f3118d6c05b0a022f230) [DeviceType](softbus.rst#ga9334bacb3ded964dc3c3367a6b70bcf4)
...
::
   ...
   typedef struct [IPublishCallback](ipublishcallback.rst) [IPublishCallback](ipublishcallback.rst)
...
::
   ...
   typedef struct [PublishInfo](publishinfo.rst) [PublishInfo](publishinfo.rst)
...
::
   ...
   enum [CommonDeviceKey](softbus.rst#ga25be99ffbe88e41f7ce51d2678010254)
...
::
   ...
   enum [DataBitMap](softbus.rst#gab839c7f1fd448f52f003ab0693f27bb4)
...
::
   ...
   enum [DeviceTypeEnum](softbus.rst#gab20b49630026f3118d6c05b0a022f230)
...
::
   ...
   enum [DiscoverMode](softbus.rst#ga7369479474cf45e9ca9c0f756473c74f)
...
::
   ...
   enum [ExchanageMedium](softbus.rst#gaf5c7c122990f0ab5bd46b9bc47b5868b)
...
::
   ...
   enum [ExchangeFre](softbus.rst#gacf2c77bd7e2c82784078762978123ea3)
...
::
   ...
   enum [PublishFailReason](softbus.rst#ga6632fcae1db4a3a13370e3fb49e5e620)
...
::
   ...
   int CreateSessionServer (const char * mouduleName, const char * sessionName, struct [ISessionListener](isessionlistener.rst) * listener )
...
`RemoveSessionServer <softbus.rst#ga225a1e178544457263d94078e638b7b5>`__
...
::
   ...
   int PublishService (const char * moduleName, const struct [PublishInfo](publishinfo.rst) * info, const struct [IPublishCallback](ipublishcallback.rst) * cb )
...
`CreateSessionServer <softbus.rst#gad7e95cced3378e8f489553d70b121392>`__
...
::
   ...
   int SetCommonDeviceInfo (const struct [CommonDeviceInfo](commondeviceinfo.rst) * devInfo, unsigned int num )
...
`PublishService <softbus.rst#ga010557e05b3f0b0b1a05157f1724e13a>`__
...
::
   ...
   [DataBitMap](softbus.rst#gab839c7f1fd448f52f003ab0693f27bb4) CapabilityMap::bitmap

**Description:**

Bitmaps. For details, see
`DataBitMap <softbus.rst#gab839c7f1fd448f52f003ab0693f27bb4>`__.
...
`Service <service.rst>`__ publishing capabilities. For details, see
**g_capabilityMap**.
...
::
   ...
   [DeviceType](softbus.rst#ga9334bacb3ded964dc3c3367a6b70bcf4) DeviceMap::devType
...
::
   ...
   [ExchangeFre](softbus.rst#gacf2c77bd7e2c82784078762978123ea3) PublishInfo::freq

**Description:**

`Service <service.rst>`__ publishing frequency
...
::
   ...
   [CommonDeviceKey](softbus.rst#ga25be99ffbe88e41f7ce51d2678010254) CommonDeviceInfo::key

**Description:**

Device information type. For details, see
`CommonDeviceKey <softbus.rst#ga25be99ffbe88e41f7ce51d2678010254>`__.
...
::
   ...
   [ExchanageMedium](softbus.rst#gaf5c7c122990f0ab5bd46b9bc47b5868b) PublishInfo::medium

**Description:**

`Service <service.rst>`__ publishing medium
...
`Service <service.rst>`__ publishing mode, which can be
`DISCOVER_MODE_PASSIVE <softbus.rst#gga7369479474cf45e9ca9c0f756473c74fac6dc5925b6fb96b8e7e094dcb16b6ebf>`__
or
`DISCOVER_MODE_ACTIVE <softbus.rst#gga7369479474cf45e9ca9c0f756473c74fa9223119d2d3b76ce474ba46fcc2b2cdb>`__
...
::
   ...
   void(* IPublishCallback::onPublishFail) (int publishId, [PublishFailReason](softbus.rst#ga6632fcae1db4a3a13370e3fb49e5e620) reason)
...
`CloseSession <softbus.rst#ga5b0c0b334f387f9c2753146ee0890780>`__.
...
`CloseSession <softbus.rst#ga5b0c0b334f387f9c2753146ee0890780>`__ to
close the session).
...
`Service <service.rst>`__ publishing ID
