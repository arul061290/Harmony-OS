...
::
   ...
   enum [OHOS::Media::PlayerCallback::PlayerInfoType](multimedia_player.rst#ga7dac9dac65cbbea7e411adcf2c314ac5) : int32_t
...
::
   ...
   enum [OHOS::Media::PlayerSeekMode](multimedia_player.rst#gad1574e5769b3174c2103a2a8b49e20d4) : int32_t
...
::
   ...
   enum [OHOS::Media::PlayerStates](multimedia_player.rst#ga8b1147e57c4a67f63f193836302da2b7) : uint32_t
...
`Prepare <multimedia_player.rst#gade9bff3268e1c409273749a90700e056>`__.
...
This function must be called after
`SetSource <multimedia_player.rst#gacce284eac910970e405151fd3a1963c0>`__.
...
::
   ...
   void OHOS::Media::Player::SetPlayerCallback (const std::shared_ptr< [PlayerCallback](ohos-media-playercallback.rst) > & cb)
...
::
   ...
   int32_t OHOS::Media::Player::SetSource (const [Source](ohos-media-source.rst) & source)
...
::
   ...
   int32_t OHOS::Media::Player::SetVideoSurface ([Surface](ohos-surface.rst) * surface)
