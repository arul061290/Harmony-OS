...
`Timestamp <ohos-audio-timestamp.md>`__. Different timing methods are
supported.
...
`SetCapturerInfo <multimedia_audiocapturer.md#gae2cf055c840ece71e22cb64c98c68a19>`__
is successful.
...
`media_errors.h <media_errors-h.md>`__ otherwise.
...
`State <abilitykit.md#ga5d74787dedbc4e11c1ab15bf487e61f8>`__.
...
`AudioCapturer <ohos-audio-audiocapturer.md>`__ instance is not
...
Releases a local `AudioCapturer <ohos-audio-audiocapturer.md>`__ object.
