...
`FrameStateCallback <ohos-media-framestatecallback.rst>`__ instance.
...
::
   ...
   virtual void OHOS::Media::FrameStateCallback::OnFrameError ([Camera](ohos-media-camera.rst) & camera, [FrameConfig](ohos-media-frameconfig.rst) & frameConfig, int32_t errorCode, FrameResult & frameResult )
...
::
   ...
   virtual void OHOS::Media::FrameStateCallback::OnFrameFinished ([Camera](ohos-media-camera.rst) & camera, [FrameConfig](ohos-media-frameconfig.rst) & frameConfig, FrameResult & frameResult )
