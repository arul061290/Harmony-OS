...
You can perform operations provided in `Use Case <use-case-5.rst>`__ to
...
Case <use-case-5.rst>`__. To customize application behavior, modify the
sample code by referring to APIs described in `Development
Guidelines <development-guidelines-2.rst>`__.
