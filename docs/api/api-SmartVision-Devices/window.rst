...
::
   ...
   enum [OHOS::WindowPixelFormat](window.rst#gade9f6a70c1e8547785d266aab3ca5725)
...
::
   ...
   virtual void OHOS::Window::BindRootView ([RootView](ohos-rootview.rst) * rootView)

**Description:**

Binds the `RootView <ohos-rootview.rst>`__ to this window.
...
::
   ...
   static [Window](ohos-window.rst)* OHOS::Window::CreateWindow (const [WindowConfig](ohos-windowconfig.rst) & config)

**Description:**

Creates a `Window <ohos-window.rst>`__ instance.
...
Returns the `Window <ohos-window.rst>`__ instance if the operation is
...
::
   ...
   static void OHOS::Window::DestoryWindow ([Window](ohos-window.rst) * window)
...
::
   ...
   virtual [Rect](ohos-rect.rst) OHOS::Window::GetRect ()
...
::
   ...
   virtual [RootView](ohos-rootview.rst)* OHOS::Window::GetRootView ()

**Description:**

Obtains the `RootView <ohos-rootview.rst>`__ bound to this window.

**Returns:**

Returns the `RootView <ohos-rootview.rst>`__ if available; returns
**nullptr** otherwise.
...
Unbinds the `RootView <ohos-rootview.rst>`__ from this window.
...
::
   ...
   [WindowPixelFormat](window.rst#gade9f6a70c1e8547785d266aab3ca5725) OHOS::WindowConfig::pixelFormat
...
::
   ...
   [Rect](ohos-rect.rst) OHOS::WindowConfig::rect
