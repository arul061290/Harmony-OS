...
`HDF_INIT <core.rst#ga99831072fdca13e3c423a14fa6a83c34>`__ must be used
to register an entry with the HDF, and the registered object must be of
the `HdfDriverEntry <hdfdriverentry.rst>`__ type.
...
::
   ...
   typedef int(* OnEventReceived) (void *priv, uint32_t id, struct [HdfSBuf](hdfsbuf.rst) *data)
...
`HdfDevEventlistener <hdfdeveventlistener.rst>`__ object.
...
::
   ...
   enum [DevicePreload](core.rst#ga0f3d81b5ff5d3896f7d8cf15f76b451e)
...
::
   ...
   enum [ServicePolicy](core.rst#ga172844da8a6908bf7226eee703ad9f80)
...
::
   ...
   const struct [HdfObject](hdfobject.rst)* DevSvcManagerClntGetService (const char * svcName)
...
::
   ...
   const char* HdfDeviceGetServiceName (const struct [HdfDeviceObject](hdfdeviceobject.rst) * deviceObject)
...
::
   ...
   int HdfDeviceRegisterEventListener (struct [HdfIoService](hdfioservice.rst) * target, struct [HdfDevEventlistener](hdfdeveventlistener.rst) * listener )

**Description:**

Registers a custom `HdfDevEventlistener <hdfdeveventlistener.rst>`__ for
...
::
   ...
   int32_t HdfDeviceSendEvent (const struct [HdfDeviceObject](hdfdeviceobject.rst) * deviceObject, uint32_t id, const struct [HdfSBuf](hdfsbuf.rst) * data )
...
`HdfDeviceRegisterEventListener <core.rst#gaa7855b3930b5378954927548e5623663>`__
...
::
   ...
   int32_t HdfDeviceSendEventToClient (const struct [HdfDeviceIoClient](hdfdeviceioclient.rst) * client, uint32_t id, const struct [HdfSBuf](hdfsbuf.rst) * data )
...
::
   ...
   int32_t HdfDeviceSubscribeService (struct [HdfDeviceObject](hdfdeviceobject.rst) * deviceObject, const char * serviceName, struct [SubscriberCallback](subscribercallback.rst) callback )
...
::
   ...
   int HdfDeviceUnregisterEventListener (struct [HdfIoService](hdfioservice.rst) * target, struct [HdfDevEventlistener](hdfdeveventlistener.rst) * listener )

**Description:**

Unregisters a previously registered
`HdfDevEventlistener <hdfdeveventlistener.rst>`__ to release resources if
...
::
   ...
   struct [HdfIoService](hdfioservice.rst)* HdfIoServiceBind (const char * serviceName, mode_t permission )
...
::
   ...
   void HdfIoServiceRecycle (struct [HdfIoService](hdfioservice.rst) * service)
...
::
   ...
   struct [HdfSBuf](hdfsbuf.rst)* HdfSBufBind (uintptr_t base, size_t size )
...
::
   ...
   struct [HdfSBuf](hdfsbuf.rst)* HdfSBufCopy (const struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
::
   ...
   void HdfSbufFlush (struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
::
   ...
   size_t HdfSbufGetCapacity (const struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
::
   ...
   uint8_t* HdfSbufGetData (const struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
::
   ...
   size_t HdfSbufGetDataSize (const struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
::
   ...
   struct [HdfSBuf](hdfsbuf.rst)* HdfSBufMove (struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
::
   ...
   struct [HdfSBuf](hdfsbuf.rst)* HdfSBufObtain (size_t capacity)
...
::
   ...
   struct [HdfSBuf](hdfsbuf.rst)* HdfSBufObtainDefaultSize (void )
...
::
   ...
   bool HdfSbufReadBuffer (struct [HdfSBuf](hdfsbuf.rst) * sbuf, const void ** data, uint32_t * readSize )
...
::
   ...
   bool HdfSbufReadInt16 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, int16_t * value )
...
::
   ...
   bool HdfSbufReadInt32 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, int32_t * value )
...
::
   ...
   bool HdfSbufReadInt64 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, int64_t * value )
...
::
   ...
   bool HdfSbufReadInt8 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, int8_t * value )
...
::
   ...
   const char* HdfSbufReadString (struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
::
   ...
   bool HdfSbufReadUint16 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, uint16_t * value )
...
::
   ...
   bool HdfSbufReadUint32 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, uint32_t * value )
...
::
   ...
   bool HdfSbufReadUint64 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, uint64_t * value )
...
::
   ...
   bool HdfSbufReadUint8 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, uint8_t * value )
...
::
   ...
   void HdfSBufRecycle (struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
::
   ...
   void HdfSbufTransDataOwnership (struct [HdfSBuf](hdfsbuf.rst) * sbuf)
...
together with
`HdfSBufBind <core.rst#gabcc9a442a3b2615828d60a1d4664b4a9>`__.
...
::
   ...
   bool HdfSbufWriteBuffer (struct [HdfSBuf](hdfsbuf.rst) * sbuf, const void * data, uint32_t writeSize )
...
::
   ...
   bool HdfSbufWriteInt16 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, int16_t value )
...
::
   ...
   bool HdfSbufWriteInt32 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, int32_t value )
...
::
   ...
   bool HdfSbufWriteInt64 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, int64_t value )
...
::
   ...
   bool HdfSbufWriteInt8 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, int8_t value )
...
::
   ...
   bool HdfSbufWriteString (struct [HdfSBuf](hdfsbuf.rst) * sbuf, const char * value )
...
::
   ...
   bool HdfSbufWriteUint16 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, uint16_t value )
...
::
   ...
   bool HdfSbufWriteUint32 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, uint32_t value )
...
::
   ...
   bool HdfSbufWriteUint64 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, uint64_t value )
...
::
   ...
   bool HdfSbufWriteUint8 (struct [HdfSBuf](hdfsbuf.rst) * sbuf, uint8_t value )
