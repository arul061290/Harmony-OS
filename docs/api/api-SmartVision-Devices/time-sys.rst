...
::
   ...
   int getitimer (int w, struct [itimerval](itimerval.rst) * old )
...
::
   ...
   int gettimeofday (struct [timeval](timeval.rst) *__restrict value, void *__restrict ovalue )
...
::
   ...
   int setitimer (int w, const struct [itimerval](itimerval.rst) *__restrict value, struct [itimerval](itimerval.rst) *__restrict ovalue )
...
::
   ...
   int settimeofday (const struct [timeval](timeval.rst) * tv, const struct [timezone](timezone.rst) * tz )
