...
::
   ...
   void(* WifiEvent::OnHotspotStaJoin) ([StationInfo](stationinfo.rst) *info)
...
::
   ...
   void(* WifiEvent::OnHotspotStaLeave) ([StationInfo](stationinfo.rst) *info)
...
::
   ...
   void(* WifiEvent::OnWifiConnectionChanged) (int state, [WifiLinkedInfo](wifilinkedinfo.rst) *info)
