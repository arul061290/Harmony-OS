...
are passed in `scandir <fs.md#gaca6df630e382cf13bac90ed6e5c4141c>`__ as
its last parameter.
...
`GLOB_NOSPACE <fs.md#gab53de39e075e6fb9a11678341772930b>`__ for running
out of memory; returns
`GLOB_ABORTED <fs.md#gab5de50cedafa21283878657d05fb2ba8>`__ for a read
error; returns
`GLOB_NOMATCH <fs.md#gaed760cf90fd4398067cdb679ebe60312>`__ for no match
found.
...
`glob() <fs.md#gae98601409da7fd3c85a9c219e1a9020c>`__.
...
to `ftw <fs.md#ga8dda75835c2b90f305d96e908dc0f84d>`__ except that it
...
`opendir <fs.md#gad09dd96447776d2bc5d8321e4b499591>`__).
...
`readdir <fs.md#ga58257faf8b13b3f14558613c632b2373>`__ call in the
directory stream.
...
`umount() <fs.md#ga44634cfa8bcc732c29bcdf5822095422>`__.
