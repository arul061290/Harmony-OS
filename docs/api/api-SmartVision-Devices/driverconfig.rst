...
::
   ...
   #define DEV_RES_NODE_FOR_EACH_ATTR( node,  attr )   for ((attr) = (node)->attrData; (attr) != [NULL](en-us_topic_0000001055198076.rst#ga070d2ce7b6bb7e5c05602aa8c308d0c4); (attr) = (attr)->next)
...
::
   ...
   #define DEV_RES_NODE_FOR_EACH_CHILD_NODE( node,  childNode )   for ((childNode) = (node)->child; (childNode) != [NULL](en-us_topic_0000001055198076.rst#ga070d2ce7b6bb7e5c05602aa8c308d0c4); (childNode) = (childNode)->sibling)
...
::
   ...
   enum [DeviceResourceType](driverconfig.rst#ga09c9585a5d95c79fd5ee4bd8863ba66a)
...
::
   ...
   struct [DeviceResourceIface](deviceresourceiface.rst)* DeviceResourceGetIfaceInstance ([DeviceResourceType](driverconfig.rst#ga09c9585a5d95c79fd5ee4bd8863ba66a) type)
