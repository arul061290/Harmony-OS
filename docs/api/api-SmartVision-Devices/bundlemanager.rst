...
`BundleInfo <bundleinfo.rst>`__ about an application, and obtain the
...
`Install <bundlemanager.rst#gaf1f1521a64cc98f076b0082df6c0abdd>`__ and
`Uninstall <bundlemanager.rst#gaa117e44378315a61b4e71fd252b2e496>`__ to
...
::
   ...
   enum [AbilityType](bundlemanager.rst#ga44b675d687acff3d739404c1227b4259)
...
::
   ...
   enum [AppexecfwkErrors](bundlemanager.rst#gac318d4f4dc0125e2367ea8c539770ed1)
...
::
   ...
   enum [LaunchMode](bundlemanager.rst#ga605d46d860e356a74db6842e66522854)
...
::
   ...
   void ClearAbilityInfo ([AbilityInfo](abilityinfo.rst) * abilityInfo)

**Description:**

Clears an `AbilityInfo <abilityinfo.rst>`__ object.

This function clears and releases the memory occupied by the fields of
the pointer type included in the specified
`AbilityInfo <abilityinfo.rst>`__ object.
...
::
   ...
   void ClearBundleInfo ([BundleInfo](bundleinfo.rst) * bundleInfo)

**Description:**

Clears a `BundleInfo <bundleinfo.rst>`__ object.

This function clears and releases the memory occupied by the fields of
the pointer type included in the specified
`BundleInfo <bundleinfo.rst>`__ object.
...
::
   ...
   void ClearElement ([ElementName](elementname.rst) * element)
...
After `AbilityInfo <abilityinfo.rst>`__ is queried, clear the internal
data of an `ElementName <elementname.rst>`__ if it is no longer required.
...
::
   ...
   void ClearModuleInfo ([ModuleInfo](moduleinfo.rst) * moduleInfo)

**Description:**

Clears a `ModuleInfo <moduleinfo.rst>`__ object.

This function clears and releases the memory occupied by the fields of
the pointer type included in the specified
`ModuleInfo <moduleinfo.rst>`__ object.
...
::
   ...
   uint8_t GetBundleInfo (const char * bundleName, int32_t flags, [BundleInfo](bundleinfo.rst) * bundleInfo )

**Description:**

Obtains the `BundleInfo <bundleinfo.rst>`__ of an application based on
...
Before querying a `BundleInfo <bundleinfo.rst>`__ object, you should
first call **memset** on the constructed `BundleInfo <bundleinfo.rst>`__
...
Returns
`ERR_OK <bundlemanager.rst#ggac318d4f4dc0125e2367ea8c539770ed1aa26c163b80b1f6786ca81dadc14b00fb>`__
if this function is successfully called; returns another error code
defined in
`AppexecfwkErrors <bundlemanager.rst#gac318d4f4dc0125e2367ea8c539770ed1>`__
otherwise.
...
::
   ...
   uint8_t GetBundleInfos (const int flags, [BundleInfo](bundleinfo.rst) ** bundleInfos, int32_t * len )

**Description:**

Obtains the `BundleInfo <bundleinfo.rst>`__ of all bundles in the system.
...
::
   ...
   uint8_t GetBundleInfosByMetaData (const char * metaDataKey, [BundleInfo](bundleinfo.rst) ** bundleInfos, int32_t * len )

**Description:**

Obtains the `BundleInfo <bundleinfo.rst>`__ of application bundles based
on the specified `MetaData <metadata.rst>`__.
...
::
   ...
   bool Install (const char * hapPath, const InstallParam * installParam, [InstallerCallback](bundlemanager.rst#ga00f021e76d728d2d44e1a28887ccc3af) installerCallback )
...
::
   ...
   uint8_t QueryAbilityInfo (const [Want](want.rst) * want, [AbilityInfo](abilityinfo.rst) * abilityInfo )

**Description:**

Queries the `AbilityInfo <abilityinfo.rst>`__ of an ability based on the
information carried in the `Want <want.rst>`__ structure.
...
Before querying an `AbilityInfo <abilityinfo.rst>`__ object, you should
first call **memset** on the constructed
`AbilityInfo <abilityinfo.rst>`__ object so that each field in it can be
...
::
   ...
   uint8_t QueryKeepAliveBundleInfos ([BundleInfo](bundleinfo.rst) ** bundleInfos, int32_t * len )

**Description:**

Obtains the `BundleInfo <bundleinfo.rst>`__ of all keep-alive
...
::
   ...
   bool SetElementAbilityName ([ElementName](elementname.rst) * element, const char * abilityName )
...
::
   ...
   bool SetElementBundleName ([ElementName](elementname.rst) * element, const char * bundleName )

**Description:**

Sets the bundle name used to query `AbilityInfo <abilityinfo.rst>`__.
...
::
   ...
   bool SetElementDeviceID ([ElementName](elementname.rst) * element, const char * deviceId )

**Description:**

Sets the device ID used to query `AbilityInfo <abilityinfo.rst>`__.
...
::
   ...
   bool Uninstall (const char * bundleName, const InstallParam * installParam, [InstallerCallback](bundlemanager.rst#ga00f021e76d728d2d44e1a28887ccc3af) installerCallback )
