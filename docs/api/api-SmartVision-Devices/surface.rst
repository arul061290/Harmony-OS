...
Returns the pointer to the `SurfaceBuffer <ohos-surfacebuffer.md>`__
object.
...
A constructor used to create a `Surface <surface.md>`__ object for
consumers to use.
...
After a consumer has used a `SurfaceBuffer <ohos-surfacebuffer.md>`__
object, the consumer can release it through
`ReleaseBuffer <surface.md#ga4150c81248f516882ef120731d9abb66>`__. The
...
A destructor used to delete the `Surface <ohos-surface.md>`__ instance.
