...
`SdioClaimIrq <sdio.rst#ga81f98e541845c15a632cf59cd9c263f8>`__ to request
the SDIO IRQ.
...
::
   ...
   enum [SdioCommonInfoType](sdio.rst#ga4037437ac001a9848dd242e8aa632678)
...
`SdioGetCommonInfo <sdio.rst#gac5c6bf733ea9e4408fd1109b18741ce8>`__ or
setting the information by calling
`SdioSetCommonInfo <sdio.rst#ga563b67c90fbb88075bf5a05d9b5d5706>`__, you
...
::
   ...
   void SdioClaimHost (struct [DevHandle](devhandle.rst) * handle)
...
`SdioReleaseHost <sdio.rst#gabd2fe2d978e7fde51eba584f30dc8e7c>`__.
...
::
   ...
   int32_t SdioClaimIrq (struct [DevHandle](devhandle.rst) * handle, [SdioIrqHandler](sdio.rst#ga858bec274683a4f50d53d1f9f43d204b) * irqHandler )
...
::
   ...
   void SdioClose (struct [DevHandle](devhandle.rst) * handle)
...
calling `SdioClose <sdio.rst#ga15427d4b231423c6de812fedffbd61e3>`__. This
function is used in pair with
`SdioOpen <sdio.rst#gadca7b0edcae3df85b3ade33704a306f8>`__.
...
::
   ...
   int32_t SdioDisableFunc (struct [DevHandle](devhandle.rst) * handle)
...
`SdioEnableFunc <sdio.rst#ga2f31cd318990db879e827e3b8f9f2393>`__.
...
::
   ...
   int32_t SdioEnableFunc (struct [DevHandle](devhandle.rst) * handle)
...
::
   ...
   int32_t SdioFlushData (struct [DevHandle](devhandle.rst) * handle)
...
::
   ...
   int32_t SdioGetCommonInfo (struct [DevHandle](devhandle.rst) * handle, [SdioCommonInfo](sdiocommoninfo.rst) * info, [SdioCommonInfoType](sdio.rst#ga4037437ac001a9848dd242e8aa632678) infoType )
...
::
   ...
   struct [DevHandle](devhandle.rst)* SdioOpen (int16_t busNum)
...
`SdioOpen <sdio.rst#gadca7b0edcae3df85b3ade33704a306f8>`__. This function
is used in pair with
`SdioClose <sdio.rst#ga15427d4b231423c6de812fedffbd61e3>`__.
...
Returns the device handle `DevHandle <devhandle.rst>`__ of the SDIO
...
::
   ...
   int32_t SdioReadBytes (struct [DevHandle](devhandle.rst) * handle, uint8_t * data, uint32_t addr, uint32_t size, uint32_t timeOut )
...
::
   ...
   int32_t SdioReadBytesFromFixedAddr (struct [DevHandle](devhandle.rst) * handle, uint8_t * data, uint32_t addr, uint32_t size, uint32_t timeOut )
...
::
   ...
   int32_t SdioReadBytesFromFunc0 (struct [DevHandle](devhandle.rst) * handle, uint8_t * data, uint32_t addr, uint32_t size, uint32_t timeOut )
...
::
   ...
   void SdioReleaseHost (struct [DevHandle](devhandle.rst) * handle)
...
This function is used in pair with
`SdioClaimHost <sdio.rst#ga86e24b0480c860cfad8ff12fbc66bc9f>`__.
...
::
   ...
   int32_t SdioReleaseIrq (struct [DevHandle](devhandle.rst) * handle)
...
This function is used in pair with
`SdioClaimIrq <sdio.rst#ga81f98e541845c15a632cf59cd9c263f8>`__.
...
::
   ...
   int32_t SdioSetBlockSize (struct [DevHandle](devhandle.rst) * handle, uint32_t blockSize )
...
::
   ...
   int32_t SdioSetCommonInfo (struct [DevHandle](devhandle.rst) * handle, [SdioCommonInfo](sdiocommoninfo.rst) * info, [SdioCommonInfoType](sdio.rst#ga4037437ac001a9848dd242e8aa632678) infoType )
...
::
   ...
   int32_t SdioWriteBytes (struct [DevHandle](devhandle.rst) * handle, uint8_t * data, uint32_t addr, uint32_t size, uint32_t timeOut )
...
::
   ...
   int32_t SdioWriteBytesToFixedAddr (struct [DevHandle](devhandle.rst) * handle, uint8_t * data, uint32_t addr, uint32_t size, uint32_t timeOut )
...
::
   ...
   int32_t SdioWriteBytesToFunc0 (struct [DevHandle](devhandle.rst) * handle, uint8_t * data, uint32_t addr, uint32_t size, uint32_t timeOut )
