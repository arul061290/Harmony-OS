OpenHarmony Lite Kernel File System
===================================

The OpenHarmony lite kernel supports the following file systems: Virtual
File System (VFS), Network File System (NFS), RAM File System (RAMFS),
File Allocation Table (FAT), and Journalling Flash File System Version 2
(JFFS2).
