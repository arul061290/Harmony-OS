...
details, see `Driver Development <driver-development.md>`__. The example
code is as follows:
...
details, see `GPIO Usage Guidelines <gpiousage-guidelines.md>`__.
...
`I2C Usage Guidelines <i2c-usage-guidelines.md>`__.
